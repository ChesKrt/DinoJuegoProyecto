...
public class ResponsiveElement : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 mobileAnchorMin = new Vector2(0f, 0f);
    [SerializeField] private Vector2 mobileAnchorMax = new Vector2(0f, 0f);
    
    [Header("Tablet Settings")]
    [SerializeField] private Vector2 tabletAnchorMin = new Vector2(0f, 0f);
    [SerializeField] private Vector2 tabletAnchorMax = new Vector2(0f, 0f);
